...
class FusionExporter:
    ...
    def extract_electronics_data(self, mcu_ref: str) -> dict[str, Any] | None:
        """
        ...
        try:
            ...
            self.logger.error(f"Failed to extract electronics data: {e!s}")
            return None
    ...
    def _extract_nets_data(self, electronics, mcu_ref: str) -> dict[str, list[str]]:
        ...
        try:
            ...
            self.logger.error(f"Error extracting nets: {e!s}")
            return {}
    ...
    def _get_mcu_pins_on_net(self, net, mcu_ref: str) -> list[str]:
        ...
        try:
            ...
            self.logger.debug(f"Error getting MCU pins: {e!s}")
    ...
    def get_available_mcus(self) -> list[dict[str, str]]:
        ...
        try:
            ...
            self.logger.error(f"Error finding MCUs: {e!s}")
    ...
    def _guess_mcu_type(self, part_name: str) -> str:
        ...
        if "rp2040" in part_name or "rp2350" in part_name:
            return "rp2040"
        if "stm32g0" in part_name:
            return "stm32g0"
        if "esp32" in part_name:
            return "esp32"
