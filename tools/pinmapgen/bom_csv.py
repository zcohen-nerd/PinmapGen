...
def parse_csv(csv_path: Union[Path, str]) -> List[Dict[str, Any]]:
    """
...
def parse_netlist_tuples(csv_path: Union[Path, str], mcu_ref: str) -> List[Tuple[str, str, str]]:
    """
...
def get_mcu_nets(csv_path: Union[Path, str], mcu_ref: str) -> Dict[str, List[str]]:
    """
