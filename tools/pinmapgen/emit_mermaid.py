...
def emit_mermaid_diagram(canonical_dict: Dict[str, Any], output_path: Union[Path, str]) -> None:
    """
...
def generate_mermaid_graph(canonical_dict: Dict[str, Any]) -> str:
    ...
    lines.extend([
        ...
        f'    %% MCU styling',
        f'    class MCU mcu',
        f'    classDef mcu fill:#607d8b,stroke:#37474f,stroke-width:3px,color:#fff',
        ''
    ])
...
def _get_node_style(net_name: str, pin: str, canonical_dict: Dict[str, Any]) -> str:
    ...
    elif pin in ['GP24', 'GP25', 'GP23']:  # Special function pins
        return 'special'
    else:
        return 'digital'
